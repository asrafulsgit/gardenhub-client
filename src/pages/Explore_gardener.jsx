            ...
            <div className="p-4 ">
              <div className="flex justify-between items-start mb-2 nunito-family">
                ...
                <div className="flex items-center">
                  ...
                  <span className="ml-1 text-gray-700 font-medium">{gardener?.rating}</span>
              ...
              <div className="flex justify-between items-center">
                ...
                <span className= ' px-2 py-0.5 rounded-sm text-sm font-[400] text-green-800   bg-green-200  nunito-family'>{gardener.experiences}</span>
              </div>
            </div>
          </div>
        ))}
