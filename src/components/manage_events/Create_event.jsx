...
const gardeningTags = [
  ...
  // }
  return (
    <section id="create-event" className={`page-section min-h-screen ${isDark ? 'bg-black' : 'bg-gray-100'} 
      py-12 px-5 `}>
...
const HelpCenter = () => {
  const {isDark} = useContext(AuthContext);
  return (
    <div className={`mt-8 ${isDark ? '' : 'bg-[#E4FEEC]'} border border-[#2BC854] rounded-lg p-6`}>
      <h3 className="text-lg font-semibold text-[#0A6B01] mb-3">
        Need Help Creating Your Event?
      </h3>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-[#2BC854]">
        <div>
