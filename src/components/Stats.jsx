  ...
  return (
    ...
    <div className={` ${isDark ? 'bg-[#ffffff07]': 'bg-green-200 border-[#f3f4f6]'} mx-5 border
      rounded-lg p-8 grid grid-cols-1 md:grid-cols-3 gap-8 text-center`}>
          <div className=''>
            <p className="text-3xl md:text-4xl font-bold text-[#2BC854] nunito-family">{inView && <CountUp end={12} duration={3} start={0} />}+</p>
          ...
          <div className=''>
            <p className="text-3xl md:text-4xl font-bold text-[#2BC854] nunito-family">{inView && <CountUp end={50} duration={3} start={0} />}k+</p>
          ...
          <div className=''>
            <p className="text-3xl md:text-4xl font-bold text-[#2BC854] nunito-family">{inView && <CountUp end={100} duration={3} start={0} />}+</p>
